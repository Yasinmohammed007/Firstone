...
def go_dependencies():
    go_repository(
        ...
        build_config = "@bazel_gazelle_go_repository_config//:WORKSPACE",
    ...
    go_repository(
        ...
        sum = "h1:rSTMM21bjNyK54KsPMno/qZY2q17Mh14wc3gOdfBudU=",
    ...
    go_repository(
        name = "com_github_kba07_config_management",
        build_config = "@bazel_gazelle_go_repository_config//:WORKSPACE",
        build_file_generation = "on",
        importpath = "github.com/KBA07/config_management",
        build_file_proto_mode = "disable_global",
        sum = "h1:Rb+/lllee/UJ3/ijGENXmz9fCA3zb64FpVYlTmYlp64=",
        version = "v0.0.0-20210415070921-a51d490291ba",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:jN6IHX1e4SRscBmV1p9iYwpfwMXVxj2BqxhxAbmSgFM=",
        version = "v1.10.1-0.20210409153801-b8530c789d0b",
    )
    go_repository(
        ...
        sum = "h1:Sxr2zpaapgpBT9ElTxTVe62W+qjnhPcKY/8W5cnA/Qk=",
        version = "v2.1.9",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:FefCKvnpEo7/05CrplralCaXhkaI5djUOZxR9Lsms5U=",
        version = "v0.0.0-20210226144353-8eae1937bf84",
    )
    go_repository(
        ...
        sum = "h1:xGmGr3zuhq9ASCu5jRdtMFdRnixhbg8TJEQ0nylyvxA=",
        version = "v0.2.4",
    )
    go_repository(
        ...
        sum = "h1:8RQxM/AY4bbfKAtYihWlyIEwKuLjNE1jzXI4gxPN27w=",
        version = "v0.10.5",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_prnvkv_my_nats",
        build_config = "@bazel_gazelle_go_repository_config//:WORKSPACE",
        build_file_generation = "on",
        build_file_proto_mode = "disable_global",
        importpath = "github.com/prnvkv/my-nats",
        sum = "h1:vAUJL6lZc1BvDgssO787IPAEy4GsArjX7TneZddZt8U=",
        version = "v0.0.0-20210421063847-c27276c1228b",
    )
    go_repository(
